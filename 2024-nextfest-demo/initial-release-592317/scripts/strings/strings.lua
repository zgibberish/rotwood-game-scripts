...
STRINGS.UI =
{
	...
	HUNTPROGRESSSCREEN = {
		...
		LOST_BEAT_MINIBOSS = {
			...
			{
				mood = "MOTIVATIONAL",
				text = "Hey, at least we grabbed some good materials to take back.",
			},
		},
		LOST_BOSS = {
			GENERAL =
...
"<i>...The Rotwood</i>."
	...
	HEARTSCREEN =
	{
		...
		ADD_MORE_HEARTS = "Upgrade your {name_multiple.konjur_heart} by defeating {name_multiple.rot_boss} in higher Frenzy Levels!",
		INTERACT = {
...
• Throw a <#RED>Striker</> immediately after catching it
	...
	SHOP_ITEM = {
		POWER = {
			...
			FULLY_UPGRADED = "Power Already Maxed",
			LIMIT_REACHED = "Power Already Received"
		},
		POTION = {
