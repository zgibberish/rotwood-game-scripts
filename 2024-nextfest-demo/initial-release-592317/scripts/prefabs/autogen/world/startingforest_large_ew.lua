...
return {
  __displayName="startingforest_large_ew",
  ambient="DFC6D4FF",
  ...
  layout="startingforest/large/startingforest_large_ew",
  rimlightcolor="FFA6BAFF",
  rimlightpos={ 0.10000000149012, 40.0, 50.0,},
  scenes={
    { name="startingforest_large_ew",},
    { name="startingforest_minigame_ew", roomtype="ranger",},
    { name="startingforest_market_ew", roomtype="market",},
  },
}
