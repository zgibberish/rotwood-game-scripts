...
return {
  __displayName="startingforest_large_nw",
  ambient="DFC6D4FF",
  ...
  layout="startingforest/large/startingforest_large_nw",
  rimlightcolor="FFA6BAFF",
  rimlightpos={ 0.10000000149012, 40.0, 50.0,},
  scene_gen_overrides={  },
  scenes={
    { name="startingforest_large_nw",},
    { name="startingforest_minigame_nw", roomtype="ranger",},
    { name="startingforest_market_nw", roomtype="market",},
  },
}
