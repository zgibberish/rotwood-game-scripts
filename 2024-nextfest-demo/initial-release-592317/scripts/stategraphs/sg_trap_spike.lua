	...
	State({
		...
		timeline =
		{
			FrameEvent(3, function(inst)
				...
				inst.components.hitbox:PushOffsetBeam(-1.40, 1.40, 0.90, 0.90, HitPriority.MOB_DEFAULT)
				inst.components.hitbox:PushOffsetBeam(-0.90, 1.40, 0.80, -0.80, HitPriority.MOB_DEFAULT)
			end),
