...
Power.AddPlayerPower("extended_range",
{
	...
	tuning =
	{
		[Power.Rarity.COMMON] = { swings = 3, damage = 200, projectiles = 1, },    --TODO: tuning, this is OP. essentially "every 3rd attack deals triple damage" vs pump+dump's "every 5th attack deals double damage"
		[Power.Rarity.EPIC] = { swings = 3, damage = 200, projectiles = 2, },      --TODO: tuning, this is OP. essentially "every 3rd attack deals triple damage" vs pump+dump's "every 5th attack deals double damage"
		[Power.Rarity.LEGENDARY] = { swings = 3, damage = 200, projectiles = 3, }, --TODO: also too much DPS
	},
