...
return {
  __displayName="startingforest_large_new",
  ambient="DFC6D4FF",
  ...
  layout="startingforest/large/startingforest_large_new",
  rimlightcolor="FFA6BAFF",
  rimlightpos={ 0.10000000149012, 40.0, 50.0,},
  scenes={
    { name="startingforest_large_new",},
    { name="startingforest_minigame_new", roomtype="ranger",},
    { name="startingforest_market_new", roomtype="market",},
  },
}
