...
return {
  __displayName="startingforest_large_nsw",
  ambient="DFC6D4FF",
  ...
  layout="startingforest/large/startingforest_large_nsw",
  rimlightcolor="FFA6BAFF",
  rimlightpos={ 0.10000000149012, 40.0, 50.0,},
  scenes={
    { name="startingforest_large_nsw",},
    { name="startingforest_minigame_nsw", roomtype="ranger",},
    { name="startingforest_market_nsw", roomtype="market",},
  },
}
