	...
	QUESTS =
	{
		...
		seen_missing_friends = {
			starting_forest = {
				...
				TALK3_GOURDO = [[
					agent:
						...
						Eh, I'll keep an eye out, but their chances aren't great.
						!notebook
						There's an extra-nasty pair of <#RED>{name_multiple.gourdo}</> roaming about.
				]],

				OPT_ALT_EXPLAIN_GOURDO = "{name_multiple.gourdo}?",
				OPT_ALT_SEEN_GOURDO = "Oh. We're acquainted.",
				OPT_ALT_KILLED_GOURDO = "Oh, I already took care of them.",
				OPT_END_GOURDO = "Okay. Thanks for your time.",

				OPT_EXPLAIN_GOURDO_RESPONSE = [[
					agent:
						!think
						Yeah, <#RED>{name_multiple.gourdo_elite}</>. They're like a couple of... big... <i>vegetables?</i>
						!shrug
						They're mean. You won't like them.
						!notebook
						Anyway-- want some <#RED>Upgrades</>? First one's on the house!
				...
				OPT_KILLED_GOURDO_RESPONSE = [[
					agent:
						!dubious
						What. The <#RED>{name_multiple.gourdo}</>?
						!gesture
						Haha, nice.
						!notebook
						Anyway, uh... want some <#RED>Upgrades</>? First one's on the house!
				]],
				--END OWL FOREST BRANCH--
			...
			owlitzer_forest = {
				...
				OPT_3B = "No, thanks. I better check out that sound.",
