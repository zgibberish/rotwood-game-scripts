...
local PowerDescriptionButton = Class(Clickable, function(self, scale)
...
function PowerDescriptionButton:SetPrice(price, is_free)
	...
	-- Sometimes we show this, we might want to hide the price display entirely: if you're just picking a power, not in the context of a shop.
	-- If so, add a "display_zero" bool to this function and check it here

	-- if is_free and not display_zero then
