...
function RadioButtons:MakeRadioButton()
    ...
    wdg.radio = Image(self.buttonsettings.atlas or "images/ui_dst.xml", self.buttonsettings.off_image or "radiobutton_off.tex")
    ...
    wdg.background = wdg:AddChild(Image("images/ui_dst.xml", "spinner_focus.tex"))
    wdg.background:SetMultColor(1,1,1,0)
    ...
    wdg.button:SetFont(self.buttonsettings.font or FONTFACE.DEFAULT)
    ...
    wdg.OnGainFocus = function(obj)
        ...
        if wdg.button:IsEnabled() then
            wdg.background:SetMultColor(1,1,1,1)
        end
    end
...
function RadioButtons:UpdateButtons()
    for i,option in ipairs(self.options) do
        ...
        if i == self.selectedIndex then
            ...
            self.buttonwidgets[i].radio:SetTexture(self.buttonsettings.atlas or "images/ui_dst.xml", self.buttonsettings.on_image or "radiobutton_on.tex")
        else
            self.buttonwidgets[i].button:Unselect()
            self.buttonwidgets[i].radio:SetTexture(self.buttonsettings.atlas or "images/ui_dst.xml", self.buttonsettings.off_image or "radiobutton_off.tex")
        end
    end
