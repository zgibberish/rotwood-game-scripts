...
function SceneGen.CollectFeaturedLocations(map_layout, world_map, authored_prop_placements)
	...
	local exits = {}
	for i = 2, #map_layout.layout.layers do
		local layer = map_layout.layout.layers[i]
