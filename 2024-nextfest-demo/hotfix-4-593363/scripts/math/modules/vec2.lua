...
function vec2.to_string(a)
	return string.format("(%s, %s)", component_to_string(a.x), component_to_string(a.y))
end
...
local Vector2 = setmetatable({}, vec2_mt)
return Vector2
