return
{
    ...
    mouse=
    {
        ...
        {button="RIGHT", ANYMOD = true, control=Controls.Digital.UNEQUIP},
        {button="LEFT",  ANYMOD = true, control=Controls.Digital.EQUIP},
    },
    ...
    gamepad=
    {
        ...
        {button="RB", control=Controls.Digital.NON_MODAL_CLICK}, -- activate non modal UI. doesn't overlap with most gameplay actions.
