		...
		twn_fallback_chat =
		{
			QUIP_CHITCHAT = {
				...
				[[
					agent:
						!bliss
						<#KONJUR>{name.i_konjur}</> is fascinating! And frightening. But mostly fascinating.
				]],
				[[
					agent:
						!bliss
			...
			talk_in_town_first_chat =
			{
				TALK_VISITOR = [[
					agent:
						...
						I'm a researcher looking into the effects of {name.i_konjur} on wildlife.
					player:
			...
			talk_to_lottie = {
				...
				TALK4 = [[
					lottie:
						...
						!point
						Hunter. It's of the utmost important that we understand what is going on, before our <#KONJUR>{name.i_konjur}</>-corrupted gut flora start eating us from the inside out!
				]],
				...
				TALK6 = [[
					lottie:
						!notebook_start
						<i>({name.npc_refiner} has already lost interest in you and is muttering to herself about <#KONJUR>{name.i_konjur}-induced aggression and "fruiting bodies.")</i>
				]],
			},
