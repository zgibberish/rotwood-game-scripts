...
return {
  __displayName="startingforest_large_sw",
  ambient="DFC6D4FF",
  ...
  layout="startingforest/large/startingforest_large_sw",
  rimlightcolor="FFA6BAFF",
  rimlightpos={ 0.10000000149012, 40.0, 50.0,},
  scenes={
    { name="startingforest_large_sw",},
    { name="startingforest_minigame_sw", roomtype="ranger",},
    { name="startingforest_market_sw", roomtype="market",},
  },
}
