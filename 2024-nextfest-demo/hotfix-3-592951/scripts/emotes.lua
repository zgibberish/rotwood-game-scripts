...
local EMOTES =
{
    ...
    ["angry"] = {
        ...
        data = { anim = "emoteXL_angry", mounted = true, mountsound = "angry", mountsounddelay = 7 * TICKS },
    },

    ["cry"] = {
        aliases = { "sad", "cries" },
        data = { anim = "emoteXL_sad", fx = "tears", fxdelay = 17 * TICKS, mounted = true, mountsound = "grunt" },
    },

    ["no"] = {
        aliases = { "annoyed", "annoy", "shakehead", "shake", "confuse", "confused" },
        data = { anim = "emoteXL_annoyed", mounted = true, mountsound = "grunt", mountsounddelay = 12 * TICKS },
    },
    ...
    ["sit"] = {
        data = { anim = { { "emote_pre_sit2", "emote_loop_sit2" }, { "emote_pre_sit4", "emote_loop_sit4" } }, randomanim = true, loop = true, fx = false, mounted = true, mountsound = "walk", mountsounddelay = 6 * TICKS },
    },

    ["squat"] = {
        data = { anim = { { "emote_pre_sit1", "emote_loop_sit1" }, { "emote_pre_sit3", "emote_loop_sit3" } }, randomanim = true, loop = true, fx = false, mounted = true, mountsound = "walk", mountsounddelay = 10 * TICKS },
    },
...
local function CreateEmoteCommand(emotedef)
    return {
        ...
        prettyname = function(command) return string.format(STRINGS.UI.BUILTINCOMMANDS.EMOTES.PRETTYNAMEFMT, kstring.first_to_upper(command.name)) end,
