...
return {
  __displayName="startingforest_large_esw",
  ambient="DFC6D4FF",
  ...
  layout="startingforest/large/startingforest_large_esw",
  rimlightcolor="FFA6BAFF",
  rimlightpos={ 0.10000000149012, 40.0, 50.0,},
  scene_gen_overrides={  },
  scenes={
    { name="startingforest_large_esw",},
    { name="startingforest_minigame_esw", roomtype="ranger",},
    { name="startingforest_large_early_esw", progress="early",},
    { name="startingforest_market_esw", roomtype="market",},
  },
}
