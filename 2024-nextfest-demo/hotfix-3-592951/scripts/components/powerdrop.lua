...
function PowerDrop:IsRelicDrop()
	return self.power_type == Power.Types.RELIC
end

function PowerDrop:IsFabledDrop()
	return self.power_type == Power.Types.FABLED_RELIC
end

function PowerDrop:IsSkillDrop()
	return self.power_type == Power.Types.SKILL
end
