...
local NumericSpinner = Class(Spinner, function( self, min, max, width, height, textinfo, atlas, textures, editable, lean, textwidth, textheight, delta)
...
function NumericSpinner:GetSelected()
	return self:GetSelectedIndex() * self.delta
end
