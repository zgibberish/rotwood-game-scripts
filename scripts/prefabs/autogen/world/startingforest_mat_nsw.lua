...
return {
  __displayName="startingforest_mat_nsw",
  ambient="DFC6D4FF",
  ...
  layout="startingforest/materials/startingforest_mat_nsw",
  rimlightcolor="FFA6BAFF",
  rimlightpos={ 0.10000000149012, 40.0, 50.0,},
  scenes={
    { name="startingforest_mat_nsw",},
    { name="resource_nsw", roomtype="resource",},
  },
}
