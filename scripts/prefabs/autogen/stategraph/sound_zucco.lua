  ...
  stategraphs={
    sg_zucco={
      ...
      sg_events={
        ...
        { eventtype="playsound", name="grunt2", param={ soundevent="zucco_grunts_2",},},
        { eventtype="playsound", name="swipe", param={ soundevent="AAAA_blank",},},
        { eventtype="playsound", name="swipe_vo_1", param={ soundevent="zucco_swipe_1",},},
        { eventtype="playsound", name="swipe_vo_2", param={ soundevent="zucco_swipe_2",},},
        { eventtype="playsound", name="swipe_vo_3", param={ soundevent="zucco_swipe_3",},},
        { eventtype="playsound", name="whoosh", param={ soundevent="AAAA_blank",},},
        { eventtype="playsound", name="foley2", param={ soundevent="zucco_foley2",},},
        { eventtype="playsound", name="foley1", param={ soundevent="zucco_foley1",},},
        { eventtype="playsound", name="idle", param={ soundevent="zucco_idle",},},
        { eventtype="playsound", name="slice1", param={ soundevent="zucco_slice_sfx1",},},
        { eventtype="playsound", name="slice2", param={ soundevent="zucco_slice_sfx2",},},
        { eventtype="playsound", name="slice3", param={ soundevent="zucco_slice_sfx3",},},
        {
          eventtype="playsound",
          name="unstuck",
          param={ soundevent="zucco_claw_unstuck",},
        },
        { eventtype="playsound", name="dig", param={ soundevent="zucco_dig",},},
        { eventtype="playfoleysound", name="footstep", param={ soundtag="Footstep",},},
        {
          eventtype="playsound",
          name="beh1",
        ...
        { eventtype="playsound", name="hit", param={ soundevent="zucco_hit",},},
        {
          eventtype="playsound",
          name="sfx-knockdown",
