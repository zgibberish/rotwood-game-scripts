...
return 	Prefab("player_cannon_projectile", bullet_fn, nil, bullet_prefabs, nil, NetworkType_SharedAnySpawn),
		Prefab("player_cannon_focus_projectile", bullet_focus_fn, nil, bullet_prefabs, nil, NetworkType_SharedAnySpawn),
		Prefab("player_cannon_shotgun_projectile", shotgun_fn, nil, bullet_prefabs, nil, NetworkType_SharedAnySpawn),
		Prefab("player_cannon_shotgun_focus_projectile", shotgun_focus_fn, nil, bullet_prefabs, nil, NetworkType_SharedAnySpawn)
