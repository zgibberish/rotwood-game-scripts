...
{
	forest = "dust_footstep_run_forest",
	swamp = "dust_footstep_run_swamp",
}
...
local PlayerStatsFXer = Class(function(self, inst)
	...
	local rundust_param =
	{
		particlefxname= biome.region_id ~= nil and rundust_prefabs[biome.region_id] or "dust_footstep_run_3",
