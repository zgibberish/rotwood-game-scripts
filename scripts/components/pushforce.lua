...
{
	[Weight.Status.s.Light] = 1.3,
	[Weight.Status.s.Normal] = 0.8,
	[Weight.Status.s.Heavy] = 0.6,
}
...
function PushForce:RemovePushForce(name, source, is_override)
	local id = (not source or is_override) and name or name .. "_" .. source.Network:GetEntityID()
