...
local AscensionModifierSource = {
	...
	{ -- Ascension 1
		...
		[EnemyModifierNames.s.BossHealthMult] = 0.15,
...
local function BuildTuning()
    local Tuning = {
			...
			trap_spores = {
				...
				VARIETIES =
				{
					trap_spores_juggernaut =
					{
						...
						target_fx = "mushroom_shrink_burst"
					},
		...
		mothball_elite = {
			...
			base_damage = 70,
			walk_speed = MONSTER_MOVE_SPEED_MOD * 5,
			multiplayer_mods = ENEMY_MULTIPLAYER_MODS.ELITE,
		},
