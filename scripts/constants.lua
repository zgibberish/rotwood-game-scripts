...
UICOLORS = {
    ...
    LIGHT_TEXT_WARN =      HexToRGB(0xF7B657FF), -- highligh something gone wrong
...
DEVICE_MAP = {
	...
	-- If platform doesn't recognize the device, we'll get the name from SDL.
	["DualSense Wireless Controller"] = "icons_ps5",
	["PS4 Controller"] = "icons_ps4",
	["XInput Controller"] = "icons_xbox360",
	["Nintendo Switch Pro Controller"] = "icons_nxpro",
