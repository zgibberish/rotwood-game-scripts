...
--    self.bg = self:AddChild(Image("images/ui_dst.xml", "white.tex")) --"blank.tex"))
--	self.bg:SetMultColor(1,1,1,0.5)
    self.bg = self:AddChild(Image("images.xml", "square.tex"))
...
function TrueScrollArea:BuildScrollBar()
    ...
    self.up_button = self.scroll_bar_container:AddChild(ImageButton("images/ui_ftf.xml", "scrollbar_slider.tex"))
    ...
    self.down_button = self.scroll_bar_container:AddChild(ImageButton("images/ui_ftf.xml", "scrollbar_slider.tex"))
    ...
    self.scroll_bar_line = self.scroll_bar_container:AddChild(Image("images/ui_ftf.xml", "scrollbar_back.tex"))
    ...
    self.scroll_bar = self.scroll_bar_container:AddChild(ImageButton("images/ui_dst.xml", "scrollbar_slider.tex", "scrollbar_slider.tex", "scrollbar_slider.tex", nil, nil, {1,1}, {0,0}))
    ...
    self.position_marker = self.scroll_bar_container:AddChild(ImageButton("images/ui_ftf.xml", "scrollbar_slider.tex"))
...
function TrueScrollArea:GetHelpText()
	...
	local t = {}
	if self:CanScroll() then
	    table.insert(t, TheInput:GetLocalizedControl(controller_id, Controls.Digital.MENU_SCROLL_BACK) .. "/" .. TheInput:GetLocalizedControl(controller_id, Controls.Digital.MENU_SCROLL_FWD) .. " " .. STRINGS.UI.HELP.SCROLL)
	end
