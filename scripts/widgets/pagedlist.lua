...
function PagedList:GetHelpText()
	...
	if self.left_button and self.left_button:IsEnabled() then
		...
		if self.right_button and self.right_button:IsEnabled() then
			table.insert(t, TheInput:GetLocalizedControl(controller_id, Controls.Digital.MENU_SCROLL_BACK, false, false) .. "/" .. TheInput:GetLocalizedControl(controller_id, Controls.Digital.MENU_SCROLL_FWD, false, false) .. " " .. STRINGS.UI.HELP.CHANGEPAGE)
		else
			table.insert(t, TheInput:GetLocalizedControl(controller_id, Controls.Digital.MENU_SCROLL_BACK, false, false) .. " " .. STRINGS.UI.HELP.PREVPAGE)
		end
	elseif self.right_button and self.right_button:IsEnabled() then
		table.insert(t, TheInput:GetLocalizedControl(controller_id, Controls.Digital.MENU_SCROLL_FWD, false, false) .. " " .. STRINGS.UI.HELP.NEXTPAGE)
	end
