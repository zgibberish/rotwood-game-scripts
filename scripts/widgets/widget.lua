...
-- Override to be notified when the input mode changes
...
function Widget:PulseColor( r1,g1,b1,a1, r2,g2,b2,a2, duration, easefn )
	if not self.inst.components.uianim then
		self.inst:AddComponent("uianim")
	end
	self.inst.components.uianim:PulseColor(r1, g1, b1, a1, r2, g2, b2, a2, duration, easefn)
	return self
end
...
function Widget:Remove()
	assert( not self.removed, self._widgetname )
