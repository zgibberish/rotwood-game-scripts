...
function templates.ScreenTitle(text)
	local title_panel = Widget()
	title_panel.bg = title_panel:AddChild(Image("images/ui_ftf/title.tex"))
	title_panel.title_text = title_panel:AddChild(Text(FONTFACE.DEFAULT, 60, text, UICOLORS.WHITE))
	return title_panel
end
