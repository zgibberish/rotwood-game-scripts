...
local FrenzySelectionWidget = Class(Widget, function(self, player)
...
function FrenzySelectionWidget:SetOwningPlayer(player)
	self.owningplayer = player
	self:OnSetOwningPlayer()
	return self
end

function FrenzySelectionWidget:GetOwningPlayer()
	return self.owningplayer
end

function FrenzySelectionWidget:OnSetOwningPlayer()
