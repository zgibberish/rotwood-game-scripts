...
local PlayerStatStack = Class(Widget, function(self)
	...
	--TODO(jambell): make all these localizable
	self.health = 				self.statsLeft:AddChild(StatStackCategory("HEALTH", "images/ui_ftf_relic_selection/stats_health.tex" ))
	...
	self.armour = 				self.statsLeft:AddChild(StatStackCategory("ARMOUR", "images/ui_ftf_relic_selection/stats_armour.tex" ))
	...
	self.divider_left_two = 	self.statsLeft:AddChild(Image("images/ui_ftf_relic_selection/stats_divider.tex"))
		:SetScale(1, 2)
	self.luck = 				self.statsLeft:AddChild(StatStackCategory("LUCK", "images/ui_ftf_relic_selection/stats_luck.tex" ))
	...
	self.divider_left_three = 	self.statsLeft:AddChild(Image("images/ui_ftf_relic_selection/stats_divider.tex"))
		:SetScale(1, 2)
	self.movespeed = 			self.statsLeft:AddChild(StatStackCategory("MOVE SPEED", "images/ui_ftf_relic_selection/stats_movspeed.tex" ))
	...
	--TODO(jambell): make all these localizable
	self.weapondamage = 		self.statsRight:AddChild(StatStackCategory("WEAPON DAMAGE", "images/ui_ftf_relic_selection/stats_weapondamage.tex" ))
	...
	self.critchance = 			self.statsRight:AddChild(StatStackCategory("CRITICAL CHANCE", "images/ui_ftf_relic_selection/stats_criticalchance.tex" ))
	...
	self.divider_right_two = 	self.statsRight:AddChild(Image("images/ui_ftf_relic_selection/stats_divider.tex"))
		:SetScale(1, 2)
	self.critdamage = 			self.statsRight:AddChild(StatStackCategory("CRITICAL DAMAGE", "images/ui_ftf_relic_selection/stats_criticaldamage.tex" ))
	...
	self.divider_right_three = 	self.statsRight:AddChild(Image("images/ui_ftf_relic_selection/stats_divider.tex"))
		:SetScale(1, 2)
	self.focusdamage = 			self.statsRight:AddChild(StatStackCategory("FOCUS DAMAGE", "images/ui_ftf_relic_selection/stats_focusdamage.tex" ))
