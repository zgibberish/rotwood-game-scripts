...
function TownHudWidget:_AddDebugButtons()
	...
	self.debug_inventory_btns:AddChild(templates.Button("Give Vert Equipment"))
		:SetDebug()
		:SetOnClickFn(function() self:OnDebugAddRelevantEquipmentButton() end)
	self.debug_inventory_btns:AddChild(templates.Button("Give Vert Materials"))
		:SetDebug()
		:SetOnClickFn(function() self:OnDebugAddReleventMaterialsButton() end)

	self.debug_inventory_btns:AddChild(templates.Button("Give All Equipment"))
		:SetDebug()
		:SetOnClickFn(function() self:OnDebugAddEquipmentButton() end)
	self.debug_inventory_btns:AddChild(templates.Button("Give All Materials"))
		:SetDebug()
		:SetOnClickFn(function() self:OnDebugAddMaterialsButton() end)
	self.debug_inventory_btns:AddChild(templates.Button("Give All Gems"))
		:SetDebug()
		:SetOnClickFn(function() self:OnDebugAddGemsButton() end)
	self.debug_inventory_btns:AddChild(templates.Button("Give All Recipe Books"))
		:SetDebug()
		:SetOnClickFn(function()
