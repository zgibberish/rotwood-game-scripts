...
local HitCounter = Class(Widget, function(self, owner)
	...
	self.hits_label = self.container:AddChild(Text(FONTFACE.DEFAULT, self.fontsize_hits, "HITS", self.color_default))
		:SetShadowColor(UICOLORS.BLACK)
		:SetShadowOffset(1, -1)
		:SetOutlineColor(UICOLORS.BLACK)
		:EnableShadow()
	...
	self.dmg_label = self.container:AddChild(Text(FONTFACE.DEFAULT, self.fontsize_dmg, "DMG", self.color_default))
		:SetShadowColor(UICOLORS.BLACK)
		:SetShadowOffset(1, -1)
		:SetOutlineColor(UICOLORS.BLACK)
		:EnableShadow()
