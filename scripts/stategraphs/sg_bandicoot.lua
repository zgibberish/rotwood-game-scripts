...
local function SpawnMobsFromHidingSpot(inst, hiding_spot)
	...
	if source and source:IsDead() then
		return
	end
...
local function TeleportToTarget(inst, offset)
	-- Teleport to a walkable point in front or behind a random target.
	local target = inst:GetRandomEntityByTagInRange(10000, inst.components.combat:GetTargetTags(), true, true)
...
local states =
{
	State({
		...
		onenter = function(inst)
			-- TODO: Should probably wait for cine to trigger us.
	...
	State({
		...
		timeline = {
			FrameEvent(7, function(inst)
				inst.components.hitbox:PushBeam(-5.00, 3.00, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(8, function(inst)
				inst.components.hitbox:PushBeam(0.50, 8.50, 2.00, HitPriority.BOSS_DEFAULT)
			end),
	...
	State({
		...
		timeline = {
			FrameEvent(2, function(inst)
				inst.components.hitbox:PushOffsetBeam(-5.00, 0.00, 2.00, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(3, function(inst)
				inst.components.hitbox:PushOffsetBeam(-5.00, 0.00, 2.00, 2.00, HitPriority.BOSS_DEFAULT)
			...
			FrameEvent(5, function(inst)
				inst.components.hitbox:PushOffsetBeam(-6.50, -1.00, 2.00, 1.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(6, function(inst)
				inst.components.hitbox:PushBeam(-4.00, 2.50, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			-- Other side now
			FrameEvent(7, function(inst)
				inst.components.hitbox:PushBeam(-4.00, 2.50, 2.00, HitPriority.BOSS_DEFAULT)
			...
			FrameEvent(8, function(inst)
				inst.components.hitbox:PushOffsetBeam(-1.50, 5.50, 2.00, 1.50, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(9, function(inst)
				inst.components.hitbox:PushOffsetBeam(-1.00, 6.00, 2.00, 1.80, HitPriority.BOSS_DEFAULT)
			end),
			...
			FrameEvent(11, function(inst)
				inst.components.hitbox:PushOffsetBeam(0.00, 6.00, 2.00, 1.80, HitPriority.BOSS_DEFAULT)
			...
			FrameEvent(13, function(inst)
				inst.components.hitbox:PushOffsetBeam(1.00, 5.50, 2.00, 1.80, HitPriority.BOSS_DEFAULT)
				inst.Physics:Stop()
			end),
	...
	State({
		...
		timeline =
		{
			...
			FrameEvent(14, function(inst)
				...
				--inst.components.hitstopper:AttachChild(inst.sg.statemem.fx)
				inst.components.hitbox:StartRepeatTargetDelay()
				inst.components.hitbox:PushBeam(2, 6.8, 2, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(15, function(inst)
	...
	State({
		...
		onenter = function(inst, target)
			inst.AnimState:PlayAnimation("bite_down_loop")
			inst.sg.statemem.target = target
			inst.components.attacktracker:CompleteActiveAttack()
			inst.components.hitbox:StartRepeatTargetDelay()
		...
		{
			FrameEvent(11, function(inst)
				inst.components.hitbox:PushBeam(-0.50, 5.00, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(12, function(inst)
				inst.components.hitbox:PushBeam(3.00, 6.80, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(13, function(inst)
				inst.components.hitbox:PushBeam(3.00, 6.80, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(25, function(inst)
				inst.components.hitbox:PushBeam(-2.00, 4.00, 2.50, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(26, function(inst)
				inst.components.hitbox:PushBeam(-3.00, 2.00, 2.50, HitPriority.BOSS_DEFAULT)
			end),
	...
	State({
		...
		onenter = function(inst, target)
			inst.AnimState:PlayAnimation("bite_down_pst")
		end,
	...
	State({
		...
		onenter = function(inst)
			...
			TeleportToTarget(inst, TELEPORT_HIDE_OFFSET_X)
		end,
	...
	State({
		...
		{
			FrameEvent(3, function(inst)
				inst.components.hitbox:PushBeam(-7.00, 7.00, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(4, function(inst)
				inst.components.hitbox:PushBeam(-3.00, 5.50, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(5, function(inst)
				inst.components.hitbox:PushBeam(-3.00, 5.50, 2.00, HitPriority.BOSS_DEFAULT)
			end),
	...
	State({
		...
		onenter = function(inst, target)
			...
			TeleportToTarget(inst, TELEPORT_RAGE_OFFSET_X)
		end,
	...
	State({
		...
		timeline = {
			FrameEvent(1, function(inst)
				inst.components.hitbox:PushBeam(-2.00, 6.00, 2.00, HitPriority.BOSS_DEFAULT)
				inst.components.offsethitboxes:Move("offsethitbox", 5.2)
			end),
			FrameEvent(2, function(inst)
				inst.components.hitbox:PushBeam(-1.00, 7.00, 2.00, HitPriority.BOSS_DEFAULT)
	...
	State({
		...
		timeline = {
			FrameEvent(31, function(inst)
				inst.components.hitbox:PushBeam(-1.60, 2.30, 2.00, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(33, function(inst)
				inst.components.hitbox:PushOffsetBeam(2.50, 8.50, 3.00, 1.50, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(48, function(inst)
				inst.components.hitbox:PushBeam(-1.73, 4.80, 2.50, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(50, function(inst)
				inst.components.hitbox:PushOffsetBeam(-5.77, -1.50, 3.00, 1.20, HitPriority.BOSS_DEFAULT)
			end),
			FrameEvent(51, function(inst)
				inst.components.hitbox:PushOffsetBeam(-7.50, -4.50, 3.00, 3.50, HitPriority.BOSS_DEFAULT)
			end),
