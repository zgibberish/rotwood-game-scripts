...
local states =
{
	State({
		...
		timeline =
		{
            FrameEvent(2, function(inst)
                ...
                inst.components.hitbox:PushBeam(0, 3.5, 2.2, HitPriority.MOB_DEFAULT)
            end),
		},
    ...
    State({
		...
		timeline =
		{
            FrameEvent(2, function(inst)
                inst.components.hitbox:StartRepeatTargetDelay()
                inst.components.hitbox:PushBeam(-3.5, 0, 2.2, HitPriority.MOB_DEFAULT)
            end),
		},
	...
	State({
		...
		timeline =
		{
            FrameEvent(3, function(inst)
                inst.components.hitbox:StartRepeatTargetDelay()
                inst.components.hitbox:PushBeam(-3.7, 3.7, 2.2, HitPriority.MOB_DEFAULT)
            end),
		},
