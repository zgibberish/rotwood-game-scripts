...
local function OnDeath(inst, data)
	--Spawn death fx
	local fx_name = inst:HasTag("elite") and "death_floracrane_elite" or "death_floracrane"
	EffectEvents.MakeEventFXDeath(inst, data.attack, fx_name, { y = 4.5 })
...
local events =
{
	...
	EventHandler("specialmovement", function(inst, target)
		...
		if trange:IsBetweenRange(MIN_HOP_RANGE, MAX_HOP_RANGE) then
...
local states =
{
	State({
		...
		timeline =
		{
			...
			FrameEvent(4, function(inst) inst.Physics:MoveRelFacing(80/150) end),
			FrameEvent(6, function(inst) inst.Physics:MoveRelFacing(160/150) end),
			...
			FrameEvent(13, function(inst) inst.Physics:MoveRelFacing(280/150) end),
			FrameEvent(16, function(inst) inst.Physics:MoveRelFacing(277/150) end),
			FrameEvent(18, function(inst) inst.Physics:MoveRelFacing(135/150) end),
	...
	State({
		...
		{
			-- Code Generated by PivotTrack.jsfl
			FrameEvent(2, function(inst) inst.Physics:MoveRelFacing(34/150) end),
			FrameEvent(4, function(inst) inst.Physics:MoveRelFacing(2/150) end),
			FrameEvent(6, function(inst) inst.Physics:MoveRelFacing(2/150) end),
			FrameEvent(33, function(inst) inst.Physics:MoveRelFacing(22/150) end),
			FrameEvent(35, function(inst) inst.Physics:MoveRelFacing(68/150) end),
			FrameEvent(37, function(inst) inst.Physics:MoveRelFacing(36/150) end),
			FrameEvent(39, function(inst) inst.Physics:MoveRelFacing(28/150) end),
			...
			FrameEvent(11, function(inst)
				...
				inst.components.hitbox:PushBeam(0, 2, 1, HitPriority.MOB_DEFAULT)
			...
			FrameEvent(13, function(inst)
				inst.components.hitbox:PushBeam(-3.5, 0, 1.5, HitPriority.MOB_DEFAULT)
			end),
	...
	State({
		...
		timeline =
		{
			...
			FrameEvent(20, function(inst)
				...
				inst.components.hitbox:PushOffsetBeam(0, 6.5, 1.5, 0, HitPriority.MOB_DEFAULT) -- For some reason pushing a PushBeam here is way offset.
			end),
			FrameEvent(21, function(inst)
				inst.components.hitbox:PushBeam(0, 6.5, 1.5, HitPriority.MOB_DEFAULT)
			end),
			...
			FrameEvent(23, function(inst)
				...
				inst.components.hitbox:PushBeam(-8, 0, 1.5, HitPriority.MOB_DEFAULT)
			end),
	...
	State({
		...
		timeline =
		{
			...
			FrameEvent(29, function(inst)
				...
				inst.components.hitbox:PushCircle(2.00, 0.00, 2.20, HitPriority.MOB_DEFAULT)
			end),

			FrameEvent(30, function(inst)
				inst.components.hitbox:PushCircle(2.20, 0.00, 1.00, HitPriority.MOB_DEFAULT)
			end),

			FrameEvent(31, function(inst)
				inst.components.offsethitboxes:SetEnabled("head_hitbox", true)
				inst.components.offsethitboxes:Move("head_hitbox", 300/150)
				inst.components.hitbox:PushCircle(2.20, 0.00, 2.00, HitPriority.MOB_DEFAULT)
				inst.sg:RemoveStateTag("flying")
			end),

			FrameEvent(32, function(inst)
				inst.components.hitbox:PushCircle(2.20, 0.00, 3.00, HitPriority.MOB_DEFAULT)
				inst.sg:RemoveStateTag("nointerrupt")
				inst.sg:AddStateTag("vulnerable")
			end),
			...
			-- Code Generated by PivotTrack.jsfl
			FrameEvent(94, function(inst) inst.Physics:MoveRelFacing(-33/150) end),
			FrameEvent(96, function(inst) inst.Physics:MoveRelFacing(-87/150) end),
			FrameEvent(98, function(inst) inst.Physics:MoveRelFacing(-54/150) end),
			FrameEvent(100, function(inst) inst.Physics:MoveRelFacing(-52/150) end),
			FrameEvent(102, function(inst) inst.Physics:MoveRelFacing(-28/150) end),
			FrameEvent(104, function(inst) inst.Physics:MoveRelFacing(-10/150) end),
			-- End Generated Code
		},
	...
	State({
		...
		timeline =
		{
			...
			FrameEvent(0, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(4, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(8, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(12, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(16, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(20, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(24, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(28, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(32, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(36, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(40, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(44, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(48, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(52, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(56, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
			FrameEvent(60, function(inst) inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 3.0, HitPriority.MOB_DEFAULT) end),
		},
	...
	State({
		...
		timeline =
		{
			--[[FrameEvent(1, function(inst)
				inst.components.hitbox:PushOffsetCircle(0.00, 0.00, 4.50, 1.50, HitPriority.MOB_DEFAULT)
			end),]]
...
SGCommon.States.AddSpawnWalkableStates(states,
{
	...
	timeline =
	{
		...
		FrameEvent(6, function(inst) inst.Physics:MoveRelFacing(270/150) end),
		FrameEvent(7, function(inst) inst.Physics:MoveRelFacing(199/150) end),
		FrameEvent(9, function(inst) inst.Physics:MoveRelFacing(240/150) end),
		FrameEvent(11, function(inst) inst.Physics:MoveRelFacing(212/150) end),
		FrameEvent(13, function(inst) inst.Physics:MoveRelFacing(163/150) end),
		FrameEvent(15, function(inst) inst.Physics:MoveRelFacing(103/150) end),
		FrameEvent(17, function(inst) inst.Physics:MoveRelFacing(74/150) end),
		FrameEvent(19, function(inst) inst.Physics:MoveRelFacing(68/150) end),
		FrameEvent(21, function(inst) inst.Physics:MoveRelFacing(64/150) end),
		FrameEvent(23, function(inst) inst.Physics:MoveRelFacing(67/150) end),
		FrameEvent(25, function(inst) inst.Physics:MoveRelFacing(40/150) end),
		-- End Generated Code
