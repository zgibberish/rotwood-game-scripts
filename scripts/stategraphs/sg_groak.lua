...
local states =
{
	...
	State({
		...
		timeline =
		{
			...
			FrameEvent(5, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_1, GROUNDPOUND_RADIUS) end),

			FrameEvent(10, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_2, GROUNDPOUND_CLOSE_RADIUS) end),
			FrameEvent(13, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_2, GROUNDPOUND_RADIUS) end),

			FrameEvent(21, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_1, GROUNDPOUND_CLOSE_RADIUS) end),
			FrameEvent(24, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_1, GROUNDPOUND_RADIUS) end),

			FrameEvent(29, function(inst) SpawnGroundPoundHitBox(inst,OFFSET_2, GROUNDPOUND_CLOSE_RADIUS) end),
			FrameEvent(32, function(inst) SpawnGroundPoundHitBox(inst,OFFSET_2, GROUNDPOUND_RADIUS) end),

			FrameEvent(40, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_1, GROUNDPOUND_CLOSE_RADIUS) end),
			FrameEvent(43, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_1, GROUNDPOUND_RADIUS) end),

			FrameEvent(48, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_2, GROUNDPOUND_CLOSE_RADIUS) end),
			FrameEvent(51, function(inst) SpawnGroundPoundHitBox(inst, OFFSET_2, GROUNDPOUND_RADIUS) end),
		},
	...
	State({
		...
		{
			EventHandler("animover", function(inst)
				inst.sg:GoToState("swallow_loop")
			end),
		},
		...
		events =
		{
			EventHandler("animover", function(inst)
				...
				if #swallowed_ents > 0 then
					...
					-- Temp: need spawn swallow anim revisions
					--inst.sg:GoToState("spawn_none")
					inst.sg:GoToState("spawn_swallow")
				end
			end),
		},
