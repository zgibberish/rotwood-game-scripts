...
Power.AddShieldPlayerPower("shield_to_health",
{
	power_category = Power.Categories.SUSTAIN,
	tuning = {
		[Power.Rarity.EPIC] = { amount = 0.5, text = STRINGS.ITEMS.SHIELD.shield_to_health.epic_string },
		[Power.Rarity.LEGENDARY] = { amount = 1, text = STRINGS.ITEMS.SHIELD.shield_to_health.legendary_string },
	},
	tooltips =
	{
		"SHIELD",
...
Power.AddShieldPlayerPower("shield_steadfast",
{
	power_category = Power.Categories.SUPPORT,
	tuning = {
		[Power.Rarity.EPIC] = { segments_required = 4, string = STRINGS.ITEMS.SHIELD.shield_steadfast.epic_string },
		[Power.Rarity.LEGENDARY] = { segments_required = 0, string = STRINGS.ITEMS.SHIELD.shield_steadfast.legendary_string },
	},
	tooltips =
	{
		"SHIELD",
