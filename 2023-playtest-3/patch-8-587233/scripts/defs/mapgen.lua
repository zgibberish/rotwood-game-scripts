...
local mapgen = {
	...
	biomes = {
		...
		treemon_forest_tutorial1 = {
			...
			room_distribution = {
				...
				['4-4'] = {
					...
					difficulty_distribution = {
						medium = 1, --This difficulty affects how much loot is dropped.
					},
				...
				-- I'm choosing right now to make no potion room appear to really crank up that pressure.
				...
				-- Don't include a potion room towards the end, to apply pressure towards returning to town.
				['12-15'] = {
					roomtype = {
						monster = 10,
						mystery = 1,
		...
		treemon_forest_tutorial2 = {
			...
			-- Consider breaking out of this after 1 piece of armour is purchased, and open up choices a bit more.
			...
			room_distribution = {
				...
				-- WARNING: Do NOT give a mystery room this early in these tutorials. That could be a Hard room which would absolutely demolish them.
				-- Give them a power upgrade room to try upgrading!
				['5-5'] = {
					roomtype = {
						-- Ideally at this point they have just under 150 konjur -- most ideally, enough to only upgrade a Common (75) and have about 70 left, then make ~30 in the next room and have enough for a Market purchase.
						-- If they have over 150, they can upgrade an Epic and be left with nothing for the Market.
						-- 149 would be the perfect amount!
						powerupgrade = 1,
						quest = 1,
					},
					reward = {
		...
		treemon_forest_tutorial3 = {
			-- This tutorial is live after you have defeated the miniboss, up until you have seen the boss for the first time
			-- This is to introduce ? Rooms and slowly start to introduce more difficulty. Very similar to tutorial2 but without guaranteed small_token.
			forbidden_keys = { "wf_first_boss_seen" },
			branchdist = {
				[1] = 3,
				[2] = 2, --JAMBELL: possibly, increase to increase likelihood of 2-branches
				[3] = 1,
			...
			room_distribution = {
				...
				-- Give them a power upgrade room to get an upgrade in! and also give them an option of a Mystery Room!
				['5-5'] = {
					force_all_roomtypes = true,
					roomtype = {
						powerupgrade = 1,
