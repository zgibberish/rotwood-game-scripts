  ...
  anim_events={
    treemon={
      attack={
        ...
        events={
          { frame=4, name="shake", postfix="_middle",},
          { frame=4, name="blink", postfix="_middle",},
          { frame=6, name="blink", postfix="_middle",},
          { frame=7, name="blink", postfix="_middle",},
          { frame=32, name="release", postfix="_middle",},
      ...
      idle={
        ...
        events={
          { frame=11, name="blink", postfix="_middle",},
          { frame=29, name="blink", postfix="_middle",},
          { frame=36, name="blink", postfix="_middle",},
        },
      },
      idle_blink={
        done=true,
        events={
          ...
          { frame=29, name="blink", postfix="_middle",},
          { frame=36, name="blink", postfix="_middle",},
          { frame=58, name="blink", postfix="_middle",},
          { frame=65, name="blink", postfix="_middle",},
        },
      },
    },
    treemon_bank={
