...
return {
  __displayName="cine_owlitzer_death_old",
  leadprefab="owlitzer",
  pause_role_sg={ lead={ resumestate="death_idle",},},
  scene_duration=134.0,
  scene_init={  },
  timelines={
    attachswipefx={  },
    blurscreen={
    ...
    letterbox={ { 0, 134.0, { eventtype="letterbox", param={  },},},},
    levelmusicstop={  },
    lightintensity={
      {
        0,
      ...
      },
      {
        ...
        {
          eventtype="lightintensity",
          param={ duration=124, self_intensity=0.5, skip_world=true, world_intensity=0.5,},
          target_role="players",
        },
      },
    },
