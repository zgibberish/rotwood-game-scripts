...
return {
  __displayName="cine_megatreemon_death",
  ...
  timelines={
    ...
    cameraoffset={
      {
        ...
        37,
        {
          ...
          param={
            ...
            duration=37,
            offset={ x=0.0, y=4.3000001907349, z=0.0,},
          },
        },
      },
      {
    ...
    letterbox={ { 0, 133, { eventtype="letterbox", param={ duration=133,},},},},
    lightintensity={
      {
        0,
        133,
      ...
      },
      {
        ...
        {
          eventtype="lightintensity",
          param={ duration=133, self_intensity=0.5, skip_world=true, world_intensity=0.5,},
          target_role="players",
        },
      },
    },
    ...
    musicbosspause={  },
    musicbossstart={  },
    musicbossstop={ { 0, 190, { eventtype="musicbossstop", param={  }, target_role="lead",},},},
    pausesg={  },
    playcountedsound={  },
    playfoleysound={  },
    playsound={  },
